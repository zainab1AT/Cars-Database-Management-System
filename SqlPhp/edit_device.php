...
if(isset($_POST['submit'])){
   ...
   if($result){
      header("Location: index_device.php ?msg=Data updated successfully");
   }
   else{
            ...
            <form action="" method="post" style="width:50vw; min-width: 300px;">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control" name="price" value="<?php echo $row['price'] ?>"><!--placeholder="name@example.com"-->
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="insertMade" class="form-control" name="made" style="width: 100px; height: 40px;" value="<?php echo $row['made'] ?>">
                        <?php
