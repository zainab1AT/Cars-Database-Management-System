...
<nav class="navbar navbar-light justify-content-between fs-3 mb-5"
    ...
    <h1 class="navbar-brand mx-auto">Orders Table</h1>
                  ...
                  while ($row = mysqli_fetch_assoc($result)) { 
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="edit_orders.php?id=<?php echo $row['id'] ?>" class="link-dark" ><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                          <a href="delete_orders.php?id=<?php echo $row['id'] ?>" class="link-dark" ><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                      </tr>
                    <?php
                  }
