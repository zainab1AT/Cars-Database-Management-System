...
<script>
    $(document).ready(function () {
        ...
        <a href="add_new_manu.php" class="btn btn-dark mb-3">Add New</a>
                  ...
                  while ($row = mysqli_fetch_assoc($result)) { 
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="edit_manu.php?name=<?php echo $row['name'] ?>" class="link-dark" ><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                          <a href="delete_manu.php?name=<?php echo $row['name'] ?>" class="link-dark" ><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                      </tr>
                    <?php
                  }
